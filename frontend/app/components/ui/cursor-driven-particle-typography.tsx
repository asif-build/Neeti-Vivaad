...
export function CursorDrivenParticleTypography({
    ...
    useEffect(() => {
        ...
        const init = () => {
            ...
            const textColor = color || computedStyle.color || "#171717";
            ...
            const effectiveFontSize = Math.min(fontSize, containerWidth * 0.14);
    ...
    return (
        <div
            ref={containerRef}
            className={cn("w-full h-full min-h-[160px] flex items-center justify-center relative touch-none select-none", className)}
        >
            <canvas
                ref={canvasRef}
