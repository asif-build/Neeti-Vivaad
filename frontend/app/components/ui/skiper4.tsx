...
/**
 * Shared Theme Hook for syncing light/dark state across buttons and document root.
 */
...
const Options = ({
  ...
  return (
    <motion.div
      className="top-30 border-foreground/10 bg-zinc-900/90 text-white absolute right-1/2 flex w-[245px] translate-x-1/2 flex-col gap-3 rounded-3xl border border-zinc-800 p-3 backdrop-blur-sm lg:right-4 lg:translate-x-0 shadow-2xl z-40"
      drag={isDragging}
      dragMomentum={false}
    >
      <div className="flex items-center justify-between">
        ...
        <p
          ...
          className="hover:bg-zinc-800 group flex cursor-pointer items-center justify-center gap-2 rounded-lg px-2 py-1 text-sm opacity-50 hover:opacity-100"
        >
          Options
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between py-1">
          ...
          <input
            ...
            className="h-1.5 w-[150px] cursor-pointer appearance-none overflow-clip rounded-lg bg-zinc-700 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white"
...
export const ThemeToggleButton1 = ({
  ...
  const global = useThemeToggle();
  const isDark = propIsDark !== undefined ? propIsDark : global.isDark;
  const toggle = propOnToggle || global.toggle;
